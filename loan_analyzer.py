...
print("The total number of loans:", num_loans)
...
print("The total of all loans:", (total_loans))

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
loan_average = total_loans/num_loans
print("The average loan amount:", loan_average)
...
print("Future value on the loan:", future_value)
...
print("Does it make sense to buy the loan?")
